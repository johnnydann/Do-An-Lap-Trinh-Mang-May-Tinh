...
import com.example.SpeedTest.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/css/**", "/js/**", "/index", "/oauth/**", "/register","/error")
                ...
                .formLogin(formLogin -> formLogin
                        ...
                        .defaultSuccessUrl("/speedtest/index") // Trang sau đăng nhập thành công.
